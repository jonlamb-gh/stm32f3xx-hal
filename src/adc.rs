        ...
        $(
            impl Adc<stm32::$adc_type> {
                ...
                pub fn disable_vbat(&self) {
                    unsafe {
                        let common = &(*stm32::$common_type::ptr());
                        common.ccr.modify(|_, w| w.vbaten().clear_bit());
                    }
                }
                ...
                pub fn enable_temperature_and_vref(&mut self) {
                    ...
                    unsafe {
                        let common = &(*stm32::$common_type::ptr());
                        common.ccr.modify(|_, w| w.tsen().set_bit().vrefen().set_bit());
                    }
                }
                ...
                pub fn disable_temperature_and_vref(&mut self) {
                    unsafe {
                        let common = &(*stm32::$common_type::ptr());
                        common.ccr.modify(|_, w| w.tsen().clear_bit().vrefen().clear_bit());
                    }
                }
                ...
                pub fn temperature_and_vref_enabled(&mut self) -> bool {
                    unsafe {
                        let common = &(*stm32::$common_type::ptr());
                        common.ccr.read().tsen().bit_is_set() &&
                ...
                pub fn disable(&mut self) {
                    self.adc_reg.cr.modify(|_, w| w.aden().clear_bit());
                }
                ...
                pub fn set_clock(&mut self, clock: config::Clock) {
                    ...
                    unsafe {
                        let common = &(*stm32::$common_type::ptr());
                        common.ccr.modify(|_, w| w.ckmode().bits(clock.into()));
                    }
                }
                ...
                pub fn set_end_of_conversion_interrupt(&mut self, eoc: config::Eoc) {
                    ...
                    self.adc_reg.ier.modify(|_, w| w.eocie().bit(en));
                    self.adc_reg.ier.modify(|_, w| w.eosie().bit(eocs));
                }

                /// Resets the end-of-conversion flag
                pub fn clear_end_of_conversion_flag(&mut self) {
                    self.adc_reg.isr.modify(|_, w| w.eoc().clear_bit().eos().clear_bit());
                }
                ...
                pub fn wait_for_conversion_sequence(&self) {
                    if !self.adc_reg.cr.read().adstart().bit_is_set() && !self.adc_reg.isr.read().eoc().bit_is_set() {
                    ...
                    //self.adc_reg.isr.modify(|_, w| w.strt().clear_bit());
                }
...
adc!(ADC1 => (adc1, ADC1_2, ahbenr, adc12en, ahbrstr, adc12rst));
